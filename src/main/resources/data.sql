...
insert into vault_job (job_title, min_salary, max_salary) values ('Developer', 30000.00, 80000.00),('Manager', 60000.00, 120000.00),('QA', 30000.00, 50000.00),('Sales', 50000.00, 100000.00);

insert into vault_employee (first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id) values ('Señor', 'Manager', 'elmanager@vault.com', '1122671112', '2010-06-01', 2, 100000.00, 0, null, null),('Brazil', 'Manager', 'brazil.manager@vault.com', '412341112', '2009-03-03', 2, 103000.00, 0, null, null);
...
insert into vault_employee (first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id) values ('Jean', 'Leduc', 'jean.leduc@vault.com', '1132445212', '2015-02-14', 4, 55000.00, 0.15, 1, 1), ('Tabatha', 'Camargo', 'tabi@vault.com', '4312521321', '2017-01-30', 1, 49500.00, 0, 1, 2);
